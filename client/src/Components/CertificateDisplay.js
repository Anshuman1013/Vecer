...
const connectWeb3 = () => {
  if (
    ...
    web3 = new Web3(
      new Web3.providers.HttpProvider(process.env.PROJECT_ENDPOINT)
    );
  } 
  else{
    web3 = new Web3(
      new HDWalletProvider("81be0952a6e28f410d94a4744319f9439fcd9fbdeda7ed6b36a0cc1daaa961fd", "https://polygon-mumbai.g.alchemy.com/v2/57_7JBY9sbmdYmfnBdUbl-mfbv36md5Q")
    //   new HDWalletProvider({mnemonic:{
    //     phrase: "bulk bus people famous flag machine faint pulse mammal unique minute member"},
    //     providerOrUrl: "https://polygon-mumbai.g.alchemy.com/v2/57_7JBY9sbmdYmfnBdUbl-mfbv36md5Q",
