...
class Admin extends React.Component {
  ...
  debugFiller() {
    ...
    this.setState({
      instituteAddress: "0xnef32kvz",
      instituteName: "ABC",
      instituteAcronym: "ABC",
      instituteWebsite: "ABC",
      instituteCourses: new Map([
  ...
  async addInstituteToBlockchain() {
    ...
    try {
      ...
      if (error.code == -32603) {
        ...
        toast.error("❌ Institute account already exits! Please check again!"); // Temporarily added to handle duplicate institute test case on goerli, that is not -32603
      }
    }
  }
      ...
      <>
        {renderLoading ? (
          ...
          <>
            {!networkError && (
              <Error
                message="You are not connected to a valid Authority account"
        ...
        {networkError && (
          <Error
            ...
            label="Please try again once you have connected to the right network (goerli testnet)"
            buttonText="Done"
          />
        )}
